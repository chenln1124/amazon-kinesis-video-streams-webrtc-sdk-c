...
#define DEFAULT_TURN_TIMER_INTERVAL_BEFORE_READY (100 * HUNDREDS_OF_NANOS_IN_A_MILLISECOND) //!< 150ms
...
// turn state timeouts
#define DEFAULT_TURN_SOCKET_CONNECT_TIMEOUT    (50 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_GET_CREDENTIAL_TIMEOUT    (50 * HUNDREDS_OF_NANOS_IN_A_SECOND)
#define DEFAULT_TURN_ALLOCATION_TIMEOUT        (50 * HUNDREDS_OF_NANOS_IN_A_SECOND) //!< 5 sec
#define DEFAULT_TURN_CREATE_PERMISSION_TIMEOUT (20 * HUNDREDS_OF_NANOS_IN_A_SECOND) //!< 2 sec
#define DEFAULT_TURN_BIND_CHANNEL_TIMEOUT      (30 * HUNDREDS_OF_NANOS_IN_A_SECOND) //!< 3 sec
#define DEFAULT_TURN_CLEAN_UP_TIMEOUT          (100 * HUNDREDS_OF_NANOS_IN_A_SECOND) //!< 10 sec
...
/**
 * @brief retrieve the ip address of the turn connection.
 *
 * @param[in] pTurnConnection the context of the turn connection.
 * @param[in, out] pKvsIpAddress the ip address of the turn connection.
 *
 * @return STATUS status of execution.
 */
 ...
 * @param[in, out] channelDataList the channel list.
 * @param[in, out] pChannelDataCount the number of the channels.
 *
 * @return STATUS status of execution
 */
